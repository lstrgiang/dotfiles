...
# Export TERM  #export TERM=rxvt-256color
# Export PATH 
...
#export PATH=$PATH:/Users/giangle/Library/Python/3.7/bin
...
export EDITOR="vim"
export GDK_SCALE=2
#export PATH=$PATH:/Users/lstgiang/node_modules/.bin
#export PATH=$PATH:$HOME/.rvm/bin
#export PATH=$PATH:/Users/lstgiang/.rvm/rubies/default/bin
...
# Chunkwm alias 
alias startchunk='brew services start crisidev/chunkwm/chunkwm'
# Khd alias 
alias startkhd='brew services start koekeishiya/formulae/khd'
# Khd alias
...
# React Prettier
alias reactcs='prettier --print-width 80 --no-semi --single-quote --trailing-comma es5 --write src/**/*.jsx'
...
#
# Project Alias
#alias ts_db='pgcli -h 0.0.0.0 -p 5432 -upostgres ts_db'
#
# Ubuntu
#alias xreload="xrdb ~/.Xresources"
#alias spotify="/var/lib/snapd/snap/bin/spotify --force-device-scale-factor=1.5"
#alias capsw="setxkbmap -option 'caps:ctrl_modifier'"
#alias screen2="xrandr --output DP1 --scale 2x2 --right-of eDP1"
#alias ag='ag --path-to-ignore ~/.ignore'
#alias go-import="goimports -w -e -d ./"
...
if [ -f '/Users/giangle/Downloads/google-cloud-sdk/path.zsh.inc' ]; then . '/Users/giangle/Downloads/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/Users/giangle/Downloads/google-cloud-sdk/completion.zsh.inc' ]; then . '/Users/giangle/Downloads/google-cloud-sdk/completion.zsh.inc'; fi
